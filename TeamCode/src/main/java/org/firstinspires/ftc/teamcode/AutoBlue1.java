...
public class AutoBlue1 extends LinearOpMode {
    ...
    final double MAGIC_FLYWHEEL_NUMBER = 7.5;
    double flywheel_rpm_error;
    double aimbot_needed_flywheel_rpm;
    final double AIMBOT_PROPORTIONAL_COEFFIEICENT = 0.002;
    final double AIMBOT_INTEGRAL_COEFFICIENT = 0.0015;
    final double AIMBOT_DERIVATIVE_COEFFICIENT = 0.0045;
    ...
    final double FLICKING_LENGTH = 500; //Milliseconds
